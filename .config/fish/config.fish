...
alias nb="$VISUAL ~/.bashrc"
alias nz="$VISUAL ~/.zshrc"
alias nf="$VISUAL ~/.config/fish/config.fish"
...
alias cat="bat"
alias man="tldr"
alias clb='echo -en "\x1b[2J\x1b[1;1H" ; echo; echo; seq 1 (tput cols) | sort -R | spark | lolcat; echo; echo'
